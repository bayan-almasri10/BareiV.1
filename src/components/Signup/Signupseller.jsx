...
const Signupseller = ({ selectForm, signUp }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await signUp(email, password, rePassword, 2, storeName);
  };
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center  justify-between mt-4">
            ...
            <Link
              ...
              className=" text-gray-500 uppercase dark:text-gray-400 no-underline flex text-sm"
            >
              <span className=" duration-500 hover:text-violet-950 -mr-1">
                {" "}
                تسجيل الدخول
              </span>
            </Link>
