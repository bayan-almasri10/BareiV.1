...
export function ProfileItem({ id, title, price, image, postFavorite ,postCart,isLiked ,inCart}) {
  ...
  function addCart() {
    ...
    return (
      <div className="w-fit mb-3 ">
        <div className="relative border border-solid border-gray-200 bg-white shadow-md w-[14rem]  h-[20rem] rounded-2xl transition-all ease-in duration-500 ">
          <div className="block overflow-hidden">
            <Image
              src={image}
              width={100}
              height={100}
              className="transition ease-in-out m-auto mt-3 rounded-2xl h-[10rem] w-[12rem] "
              alt="product"
            />
          </div>
